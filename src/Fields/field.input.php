...
if(false == class_exists('FieldInput')) {
class FieldInput extends Field implements ExportableField, ImportableField
{
    ...
    public function displayPublishPanel(XMLElement &$wrapper, $data = null, $flagWithError = null, $fieldnamePrefix = null, $fieldnamePostfix = null, $entry_id = null)
    {
        ...
        $label->appendChild(Widget::Input('fields'.$fieldnamePrefix.'['.$this->get('element_name').']'.$fieldnamePostfix, (0 != strlen($value) ? $value : null)));

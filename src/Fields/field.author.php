...
class FieldAuthor extends Field implements ExportableField
{
    ...
    {
        if ('author_types' === $field && !is_array($value)) {
            $value = explode(',', $value);
        }
    ...
    public function displayPublishPanel(XMLElement &$wrapper, $data = null, $flagWithError = null, $fieldnamePrefix = null, $fieldnamePostfix = null, $entry_id = null)
    {
        ...
        if ('yes' === $this->get('default_to_current_user') && empty($data) && empty($_POST)) {
    ...
    public function prepareExportValue($data, $mode, $entry_id = null)
    {
        ...
        if (isset($data['author_id']) && false === is_array($data['author_id'])) {
    ...
    public function buildDSRetrievalSQL($data, &$joins, &$where, $andOperation = false)
    {
        ...
        if (self::isFilterRegex($data[0])) {
            ...
            foreach ($data as $value) {
                ...
                if ('author_id' == self::__parseFilter($value)) {
                    $where .= "

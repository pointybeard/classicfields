 ...
 * input into it.
 */
if(false == class_exists('FieldDate')) {
class FieldDate extends Field implements ExportableField, ImportableField
{
    ...
    public static function parseFilter(&$string)
    {
        ...
        if (preg_match('/^(equal to or )?(earlier|later) than (.*)$/i', $string, $match)) {
            ...
            $parts = self::parseDate($string, $match[2], 'equal to or ' == $match[1]);
    ...
    public function displayPublishPanel(XMLElement &$wrapper, $data = null, $flagWithError = null, $fieldnamePrefix = null, $fieldnamePostfix = null, $entry_id = null)
    {
        ...
        // New entry
        if (empty($data) && null === $flagWithError && null !== $this->get('pre_populate')) {
        ...
        if ('yes' === $this->get('calendar')) {
            ...
            $calendar->appendChild(Widget::Calendar(('yes' === $this->get('time'))));
    ...
    public function processRawFieldData($data, &$status, &$message = null, $simulate = false, $entry_id = null)
    {
        ...
        } elseif (self::__OK__ == $status && DateTimeObj::validate($data)) {

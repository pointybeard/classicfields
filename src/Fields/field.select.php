...
class FieldSelect extends FieldTagList implements ExportableField, ImportableField
{
    ...
    {
        return 'yes' === $this->get('allow_multiple_selection') ? false : true;
    }
    ...
    public function findAndAddDynamicOptions(&$values)
    {
        ...
        if ((bool) Symphony::Database()->fetchVar('Field', 0, sprintf(
        ...
        if ((false == $results) && (bool) Symphony::Database()->fetchVar('Field', 0, sprintf(
            "SHOW COLUMNS FROM `tbl_entries_data_%d` LIKE '%s'",
            $this->get('dynamic_options'),
            'file'
        ))) {
    ...
    public function checkFields(array &$errors, $checkForDuplicates = true)
    {
        ...
        if ('' == $this->get('static_options') && ('' == $this->get('dynamic_options') || 'none' == $this->get('dynamic_options'))) {
    ...
    public function commit()
    {
        ...
        $fields['sort_options'] = 'yes' === $this->get('sort_options') ? 'yes' : 'no';
        ...
        if (null !== $field_id && is_numeric($field_id)) {
            SectionManager::createSectionAssociation(null, $id, (int) $field_id, 'yes' === $this->get('show_association') ? true : false, $this->get('association_ui'), $this->get('association_editor'));
        }
    ...
    public function displayPublishPanel(XMLElement &$wrapper, $data = null, $flagWithError = null, $fieldnamePrefix = null, $fieldnamePostfix = null, $entry_id = null)
    {
        ...
        if ('yes' === $this->get('allow_multiple_selection')) {
            $fieldname .= '[]';
        }
        ...
        $label->appendChild(Widget::Select($fieldname, $options, ('yes' === $this->get('allow_multiple_selection') ? array('multiple' => 'multiple', 'size' => count($options)) : null)));
    ...
    public function prepareImportValue($data, $mode, $entry_id = null)
    {
        ...
        if ($mode === $modes->getValue) {
            if ('no' === $this->get('allow_multiple_selection')) {
    ...
    public function prepareExportValue($data, $mode, $entry_id = null)
    {
        ...
        if (isset($data['handle']) && false === is_array($data['handle'])) {
            $data['handle'] = array(
                $data['handle'],
            );
        }

        if (isset($data['value']) && false === is_array($data['value'])) {
            $data['value'] = array(
                $data['value'],
            );
        }
    ...
    public function getExampleFormMarkup()
    {
        ...
        $label = Widget::Label($this->get('label'));
        $label->appendChild(Widget::Select($fieldname, $options, ('yes' === $this->get('allow_multiple_selection') ? array('multiple' => 'multiple') : null)));
